...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(key:UniqueKey(),title: 'Path Provider'),
    );
  }
}
  ...
  void _requestExternalStorageDirectory() {
    setState(() async {
     _externalDocumentsDirectory = getExternalStorageDirectory() as Future<Directory>?;
      var extDir = (await _externalDocumentsDirectory)!.path;

      var file = File(("$extDir/dummy+${DateTime.now().microsecondsSinceEpoch}.jpg").trim());
      file.writeAsString("bla bla");
      print(file.path);
      print(file.uri);
